<template>
    <div>
      ...
      <ul>
        <li><label>Latitude</label><input v-model.number="state.observatory.latitude"></li>
        <li><label>Longitude</label><input v-model.number="state.observatory.longitude"></li>
        <li><label>Time zone (IANA)</label><time-zone-selector v-model="state.observatory.timeZone"></time-zone-selector></li>
      </ul>
      </div>
      <div id="observation">
      <h1>
      ...
      <ul>
        <li><label>Local date at nightfall</label><date-entry v-model="state.observation.date" v-bind:timezone="state.observatory.timeZone"></date-entry></li>
  ...
  <div id="target">
    ...
    <simbad-target v-model="state.target"></simbad-target>
  </div>
  <div id="companions">
    <h1>
    Companions
    </h1>
    <companion-list v-bind:companions="state.companions"></companion-list>
  </div>
    </div>
</template>
<script>
